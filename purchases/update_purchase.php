...
if (!$purchase) {
    // Redirect to purchases list if purchase not found
                ...
                <form action="" method="post" id="purchaseForm">
                    <div class="row mb-3">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="referenceNo" name="reference_no" value="<?php echo htmlspecialchars($purchase['reference_no']); ?>" readonly>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select" id="status" name="status">
                                <option value="1" <?php echo ($purchase['status'] == 1) ? 'selected' : ''; ?>>Completed</option>
                                <option value="2" <?php echo ($purchase['status'] == 2) ? 'selected' : ''; ?>>Pending</option>
                                <option value="0" <?php echo ($purchase['status'] == 0) ? 'selected' : ''; ?>>Cancelled</option>
                            </select>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" step="0.01" class="form-control" id="totalAmount" name="total_amount" value="<?php echo $purchase['total_amount']; ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label for="paidAmount" class="col-sm-4 col-form-label">Paid Amount</label>
                                        <div class="col-sm-8">
                                            <input type="number" step="0.01" class="form-control" id="paidAmount" name="paid_amount" value="<?php echo $purchase['paid_amount']; ?>">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label for="dueAmount" class="col-sm-4 col-form-label">Due Amount</label>
                                        <div class="col-sm-8">
                                            <input type="number" step="0.01" class="form-control" id="dueAmount" value="<?php echo $purchase['due_amount']; ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-select" id="paymentMethod" name="payment_method_id">
                                                <option value="1" <?php echo ($purchase['payment_method_id'] == 1) ? 'selected' : ''; ?>>Cash</option>
                                                <option value="2" <?php echo ($purchase['payment_method_id'] == 2) ? 'selected' : ''; ?>>Bank Transfer</option>
                                                <option value="3" <?php echo ($purchase['payment_method_id'] == 3) ? 'selected' : ''; ?>>Credit Card</option>
                                                <option value="4" <?php echo ($purchase['payment_method_id'] == 4) ? 'selected' : ''; ?>>Debit Card</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
