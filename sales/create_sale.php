...
$reference_no = $saleObj->generateReferenceNo();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($saleObj->create()) {
        ...
        // Redirect to sales list after successful creation
        header("Location: sales.php");
        exit();
    } else {
        $error_message = "Failed to create sale. Please try again.";
    }
}
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const initialRow = document.querySelector('#saleItemsTable tbody tr');
